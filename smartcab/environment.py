...
class Environment(object):
    ...
    def create_agent(self, agent_class, *args, **kwargs):
        ...
        agent = agent_class(self, *args, **kwargs) # learning agent OR dummy agent
    ...
    def sense(self, agent):
        ...
        heading = state['heading']       # direction to go next
        ...
        for other_agent, other_state in self.agent_states.iteritems():
            ...
            # for agents have nothing to do with this traffic
